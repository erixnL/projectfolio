...
<section class="container mx-auto p-4 mt-4">
      ...
      <?php endif; ?>
        ...
        <div class="p-4">
          ...
          <ul class="my-4 bg-gray-100 p-4">
            <li class="mb-2"><strong>Tech Stack:</strong> <?= $listing->tech_stack ?></li>
            <li class="mb-2">
    ...
    <section class="container mx-auto p-4">
      ...
      <div class="rounded-lg shadow-md bg-white p-4">
        ...
        <h3 class="text-lg font-semibold mt-4 mb-2 text-blue-500">What you can gain</h3>
        <p><?= $listing->benefits ?></p>
      </div>
      <p class="my-5">
        Put specific "Project Name" as the subject of your email and express your interests.
      </p>
      <a
